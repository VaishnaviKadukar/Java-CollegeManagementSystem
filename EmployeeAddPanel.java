 ...
 * @author Asus
 */
public class EmployeeAddPanel extends javax.swing.JFrame {

    /**
     * Creates new form EmployeeAddPanel
     */
    Connection con;
   Statement st;
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "cleark", "manager", "labauratory cleark" }));
        ...
        jLabel14.setText("Insert Employee Records");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         try{
            ...
            String sql="insert into employee(firstname,lastname,position,age,contact,emailid,gender,permanentaddress,presentaddress) values('"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"','"+s11+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeAddPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
