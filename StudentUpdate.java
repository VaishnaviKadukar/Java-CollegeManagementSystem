...
Statement st;
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Update Student Records");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 1202, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
 ...
 String s9=rs.getString("emailid");
 String s10=rs.getString("gender");
 String s11=rs.getString("permanentaddress");
 String s2=rs.getString("firstname");
 String s3=rs.getString("firstname");
 String s4=rs.getString("lastname");
 String s5=rs.getString("class");
 String s6=rs.getString("year"); 
 ...
 jTextArea2.setText(s12);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(q==0){
               String sql="update student set firstname='"+x1+"' , lastname='"+x2+"' , class='"+x3+"' ,  year='"+x4+"' , dob='"+x6+"' ,  contact='"+x5+"' ,  emailid='"+x8+"' ,  gender='"+x7+"', permanentaddress='"+x9+"', presentaddress='"+x10+"' where id='"+z+"' ";
