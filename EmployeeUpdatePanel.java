 ...
 * @author Asus
 */
public class EmployeeUpdatePanel extends javax.swing.JFrame {
Connection con;
Statement st;
    /**
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Update Employee Records");
...
try{
       ...
       String sql="select *from employee where id='"+s1+"'";
 ...
 jTextArea2.setText(s12);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(z.isEmpty()){
                ...
                String sql="update employee set firstname='"+x1+"' , lastname='"+x2+"' , position='"+x3+"' ,  age='"+x4+"'  ,  contact='"+x5+"' ,  emailid='"+x8+"' ,  gender='"+x7+"', permanentaddress='"+x9+"', presentaddress='"+x10+"' where id='"+z+"' ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeUpdatePanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
